        ...
        <dialog id="my_modal_5" className="modal modal-bottom sm:modal-middle">
            <div className="modal-box w-[calc(96vw)] h-screen">
                ...
                <div className=' p-1 flex-col'>
                    <img src={selectedRide.map} className='absolute w-[calc(100vw)] inset-0 z-0 h-screen'/>
                    <div className='z-10 relative top-0 bg-white rounded-2xl p-4 w-fit space-y-0 mx-auto'>
                    ...
                    <div className='z-10 relative mx-auto -bottom-[calc(50vh)] sm:-bottom-36 w-full bg-white rounded-2xl px-4 py-2 '>
